...
public class DBBackup {
    ...
    public static String mysqlDatabaseBackUp() {
        ...
        File file = new File("E:\\Hibernate\\SatHachLaiXe\\web\\db");
        if (!file.exists()) {
            if (file.mkdir()) {
                System.out.println("Directory is created!");

                String backUpPath = "E:\\Hibernate\\SatHachLaiXe\\web\\db";
                String host = "localhost";
                String mysqlPort = "3306";
                String dbUser = "root";
                String dbPassword = "vanthan";
                String database = "sathachlaixe";
